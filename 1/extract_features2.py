...
def extract_feature(_audio_filename, nb_mel_bands, nb_frames, nfft):
    ...
    for i in range(nb_frames):
        ...
        _fft_en = np.abs(fft(y_win)[:1 + int(nfft / 2)]) ** 2
...
speech_audio_folder = '/Users/amir/Desktop/4thPeriod/AdvancedAudio/Ex/1/data/speech_wav'
music_audio_folder = '/Users/amir/Desktop/4thPeriod/AdvancedAudio/Ex/1/data/music_wav'
